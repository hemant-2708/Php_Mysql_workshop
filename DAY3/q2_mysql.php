...
if (isset($_POST['name'], $_POST['mk1'], $_POST['mk3'], $_POST['mk4'], $_POST['mk5'])){
	...
	if ($a && $sub1 && $sub2 && $sub3 && $sub4 && $sub5){
		...
		echo "Percentage: ".$p;
		$query = "INSERT INTO class1 (Name, Sub1, Sub2, Sub3, Sub4, Sub5, Totalobtained, Totalmarks, Percentage) VALUES ('$a', '$sub1', '$sub2', '$sub3', '$sub4', '$sub5', '$total', '$totalmks', '$p')";
...
$update_1 = "UPDATE class1 SET Sub5 = 99 WHERE id = 3";
mysqli_query($connect, $update_1);
mysqli_query($connect, "UPDATE class1 SET Totalobtained = 385 WHERE id = 3");
mysqli_query($connect, "UPDATE class1 SET Percentage = 77 WHERE id = 3");
